    ...
    <body class="font-sans antialiased">
        ...
        <footer class="bg-white dark:bg-gray-800 shadow">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; 2023 <a href="https://flowbite.com/" class="hover:underline">{{ config('app.name', 'Laravel')}}</a>. All Rights Reserved.
                </span>
...
<a href="https://wa.me/087758702901" class="fixed bottom-10 right-10 flex items-center space-x-2 z-50 group" target="_blank">
    <div title="feel free to ask us anything" class="w-16 h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg dark:bg-green-400">
        ...
        <script> // Function to update the favicon based on the color scheme 
        function updateFavicon() { 
        const favicon = document.getElementById('favicon'); 
        const darkModeMediaQuery = window.matchMedia('(prefers-color-scheme: dark)'); 
        if (darkModeMediaQuery.matches) 
        { favicon.href = '{{ asset('asset/img/DivFusionLogoWhite.svg') }}'; } 
        else { favicon.href = '{{ asset('asset/img/DivFusionLogo.svg') }}'; } 
